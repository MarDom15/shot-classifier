...
Le cahier des charges complet (contexte, objectifs, exigences, méthodologie, limites connues, feuille de route) est dans [`CAHIER_DES_CHARGES.md`](CAHIER_DES_CHARGES.md) — à lire en premier pour comprendre les choix de conception. Pour un manuel opérationnel complet, pas à pas (installation, lancement, chaque composant, pièges rencontrés), voir [`docs/MANUEL_PROJET.md`](docs/MANUEL_PROJET.md) / [`docs/Manuel_Projet_Shot_Classifier.docx`](docs/Manuel_Projet_Shot_Classifier.docx) (également disponible en anglais : [`docs/PROJECT_MANUAL.md`](docs/PROJECT_MANUAL.md) / [`docs/Project_Manual_Shot_Classifier.docx`](docs/Project_Manual_Shot_Classifier.docx)).
